...
import { adminFirstTimeSetPass } from '../../APIs/authAPI';

const { Title, Text } = Typography;

function AdminFirstTimeSetPass() {
  ...
  const onFinishSuccess = async (data) => {
    try {
      setIsLoading(true);
      const response = await adminFirstTimeSetPass(data, accessToken);
...
export default AdminFirstTimeSetPass;
